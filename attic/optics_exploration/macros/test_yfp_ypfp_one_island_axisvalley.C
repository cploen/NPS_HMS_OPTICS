// test_yfp_ypfp_one_island_axisvalley.C
//
...
// Usage:
//   hcana -l
//   .x test_yfp_ypfp_one_island_axisvalley.C(1544,"axisvalley_test1","-1","multifoil_test1",0,2)
//
// Main knobs:
...
void test_yfp_ypfp_one_island_axisvalley(Int_t nrun=1544,
                              const char *tag="axisvalley_test1",
                              ...
                              Double_t maxNeighborFrac=0.18)
{
  ...
  TString outPdf = Form("plots/test_yfp_ypfp_one_island_axisvalley_run%d_%s.pdf", nrun, outTag.Data());

  TCanvas *c = new TCanvas("c_axisvalley", "axis-valley YpFp/YFp diagnostic", 1100, 850);
  TLatex tx;
  tx.SetNDC();
