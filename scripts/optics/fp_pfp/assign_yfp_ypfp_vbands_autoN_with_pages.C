// assign_yfp_ypfp_vbands_autoN_with_pages.C
...
//   hcana -l -q 'assign_yfp_ypfp_vbands_autoN_with_pages.C(1544,-5,0,"auto_ycut")'
//
// Useful tuning, if needed:
//   hcana -l -q 'assign_yfp_ypfp_vbands_autoN_with_pages.C(1544,-5,0,"auto_ycut",7,0.55,0.45)' 
// where the last numbers are: nLocalPcaPeaks, maxVBands, peakSepZ, coreRadiusZ, minVPeakSep, minPeakFraction.
...
void assign_yfp_ypfp_vbands_autoN_with_pages(Int_t nrun=1544,
  ...
  TString outbase = Form("plots/yfp_ypfp_vband_autoN_pages_run%d_delta_%g_to_%g", nrun, deltaMin, deltaMax);
