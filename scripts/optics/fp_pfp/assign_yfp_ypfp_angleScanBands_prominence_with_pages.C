// assign_yfp_ypfp_angleScanBands_prominence_with_pages.C
//
...
//   hcana -l -q 'assign_yfp_ypfp_angleScanBands_prominence_with_pages.C(1544,-10,-8,"auto_ycut")'
//
// Useful test:
//   hcana -l -q 'assign_yfp_ypfp_angleScanBands_prominence_with_pages.C(1544,-8,-5,"auto_ycut",9,1.0,0.18,0.05,0.15,2)'
...
void assign_yfp_ypfp_angleScanBands_prominence_with_pages(Int_t nrun=1544,
  ...
  TString outbase = Form("plots/yfp_ypfp_angleScanPromBand_pages_run%d_delta_%g_to_%g", nrun, deltaMin, deltaMax);
