...
// the settings that work even for those shoulders
// hcana -l -q 'assign_xfp_xpfp_angleScanBands_strongWeak_with_pages.C(1544,-8,-5,"auto_ycut",9,1.0,0.18,0.05,0.15,0,0.005,0.04,0.45)'
...
void assign_xfp_xpfp_angleScanBands_strongWeak_with_pages(Int_t nrun=1544,
  ...
  TString outbase = Form("plots/xfp_xpfp_angleScanStrongWeakBand_pages_run%d_delta_%g_to_%g", nrun, deltaMin, deltaMax);
