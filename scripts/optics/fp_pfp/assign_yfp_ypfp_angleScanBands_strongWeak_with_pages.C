...
static TCutG* LoadYtarCut_angleScan(int nrun, const TString& ytarTag, int foilIndex=0) {
  TString fname = Form("cuts/ytar_ridge_cut__run%d.root",  nrun);
...
void assign_yfp_ypfp_angleScanBands_strongWeak_with_pages(Int_t nrun=1544,
  ...
  TString outbase = Form("plots/yfp_ypfp_angleScanStrongWeakBand_pages_run%d_delta_%g_to_%g", nrun, deltaMin, deltaMax);
